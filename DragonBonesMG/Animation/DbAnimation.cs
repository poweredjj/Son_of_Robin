...
namespace DragonBonesMG.Animation
{
    ...
    public class DbAnimation
    {
        ...
        {
            if (e.Action != null) _armature.OnAction(new DbAnimationEventArgs(e.Action));
            if (e.Event != null) _armature.OnAnimationEvent(new DbAnimationEventArgs(e.Event));
            if (e.Sound != null) _armature.OnSound(new DbAnimationEventArgs(e.Sound));
        }
