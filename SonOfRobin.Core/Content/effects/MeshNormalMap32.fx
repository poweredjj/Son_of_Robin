...
float3 lightPosArray[32]; // line changed between 2-7-32 light versions
float4 lightColorArray[32]; // line changed between 2-7-32 light versions
float lightRadiusArray[32]; // line changed between 2-7-32 light versions
int noOfLights;
...
float4 MainPS(VertexShaderOutput input) : COLOR0
{
    ...
    for (int i = 0; i < 32; i++) // line changed between 2-7-32 light versions
    {                         
