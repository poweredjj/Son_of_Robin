...
namespace SonOfRobin
{
    ...
    {
        public static readonly float version = 8.3f;
        public static readonly DateTime lastChanged = new DateTime(2022, 04, 29);
