        ...
        public struct Task
        {
            ...
            public void Execute()
            {
                ...
                switch (taskName)
                {
                    ...
                    case TaskName.RefreshPlayerStorages:
                        {
                            Player player = (Player)this.ExecuteHelper;
                            player.RefreshAllowedPiecesForStorages();

                            new TextWindow(text: "Player storages has been refreshed.", animate: false, useTransition: false, bgColor: Color.Green, textColor: Color.White);
