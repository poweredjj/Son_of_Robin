    ...
    public class InputMapper
    {
        ...
        public static void RebuildMappings()
        {
            ...
            // world
            {
                ...
                new Mapping(action: Action.WorldStatsMenu, anyInputList: new List<object> { keybMap.statsMenu, padMap.statsMenu, VButName.StatsMenu });
