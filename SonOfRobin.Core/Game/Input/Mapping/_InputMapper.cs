...
namespace SonOfRobin
{
    public class InputMapper
    {
        ...
        public static readonly InputPackage defaultMappingGamepad = new(packageVersion: InputPackage.version, analogMovement: new StoredInput(AnalogType.PadLeft), analogCamera: new StoredInput(AnalogType.PadRight), confirm: new StoredInput(Buttons.A), cancel: new StoredInput(Buttons.B), pauseMenu: new StoredInput(Buttons.Start), sprint: new StoredInput(Buttons.LeftStick), inventory: new StoredInput(Buttons.Y), pickUp: new StoredInput(Buttons.X), highlightPickups: new StoredInput(Buttons.B), pingArea: new StoredInput(Buttons.RightStick), craft: new StoredInput(Buttons.DPadUp), interact: new StoredInput(Buttons.A), map: new StoredInput(Buttons.DPadRight), useTool: new StoredInput(Buttons.RightTrigger), zoomOut: new StoredInput(Buttons.LeftTrigger), toolbarPrev: new StoredInput(Buttons.LeftShoulder), toolbarNext: new StoredInput(Buttons.RightShoulder), invSwitch: new StoredInput(Buttons.LeftStick), invPickOne: new StoredInput(Buttons.Y), invPickStack: new StoredInput(Buttons.X), invSort: new StoredInput(Buttons.RightStick), mapToggleMarker: new StoredInput(Buttons.A), mapDeleteMarkers: new StoredInput(Buttons.Y), mapToggleLocations: new StoredInput(Buttons.X), mapCenterPlayer: new StoredInput(Buttons.LeftStick), mapZoomIn: new StoredInput(Buttons.RightTrigger), mapZoomOut: new StoredInput(Buttons.LeftTrigger));

        public static readonly InputPackage defaultMappingKeyboard = new(packageVersion: InputPackage.version, analogMovement: new StoredInput(AnalogType.FromKeys), analogCamera: new StoredInput(AnalogType.Empty), confirm: new StoredInput(Keys.Enter), cancel: new StoredInput(Keys.Escape), pauseMenu: new StoredInput(Keys.Back), sprint: new StoredInput(Keys.NumPad0), inventory: new StoredInput(Keys.Enter), pickUp: new StoredInput(Keys.RightControl), highlightPickups: new StoredInput(Keys.NumPad4), pingArea: new StoredInput(Keys.NumPad7), craft: new StoredInput(Keys.NumPad5), interact: new StoredInput(Keys.RightShift), map: new StoredInput(Keys.M), useTool: new StoredInput(Keys.Space), zoomOut: new StoredInput(Keys.NumPad1), toolbarPrev: new StoredInput(Keys.OemOpenBrackets), toolbarNext: new StoredInput(Keys.OemCloseBrackets), invSwitch: new StoredInput(Keys.Tab), invPickOne: new StoredInput(Keys.RightShift), invPickStack: new StoredInput(Keys.Space), invSort: new StoredInput(Keys.LeftShift), mapToggleMarker: new StoredInput(Keys.Space), mapDeleteMarkers: new StoredInput(Keys.V), mapToggleLocations: new StoredInput(Keys.C), mapCenterPlayer: new StoredInput(Keys.A), mapZoomIn: new StoredInput(Keys.X), mapZoomOut: new StoredInput(Keys.Z), left: new StoredInput(Keys.Left), right: new StoredInput(Keys.Right), up: new StoredInput(Keys.Up), down: new StoredInput(Keys.Down));
        ...
        public static void RebuildMappings()
        {
            ...
            // global
            {
                ...
                new Mapping(action: Action.GlobalCancelReturnSkip, anyInputList: new List<object> { keybMap.cancel, padMap.cancel, VButName.Return, VButName.WakeUp, MouseAction.RightButton });
            ...
            // world
            {
                ...
                new Mapping(action: Action.WorldHighlightPickups, anyInputList: new List<object> { keybMap.highlightPickups, padMap.highlightPickups }); // VButName is used separately (coupled object logic)

                new Mapping(action: Action.WorldPingArea, anyInputList: new List<object> { keybMap.pingArea, padMap.pingArea, VButName.PingArea });
            ...
            // map
            {
                ...
                new Mapping(action: Action.MapDeleteMarkers, anyInputList: new List<object> { keybMap.mapDeleteMarkers, padMap.mapDeleteMarkers, VButName.MapDeleteMarkers });
                ...
                new Mapping(action: Action.MapToggleLocations, anyInputList: new List<object> { keybMap.mapToggleLocations, padMap.mapToggleLocations }); // VButName is used separately (coupled object logic)
            }
