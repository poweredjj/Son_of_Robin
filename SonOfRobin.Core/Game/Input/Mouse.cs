...
namespace SonOfRobin
{
    ...
    // expands Mouse class with new functions
    {
        ...
        public static bool LeftHasBeenReleased { get {
                MessageLog.AddMessage(currentFrame: SonOfRobinGame.currentUpdate, msgType: MsgType.Debug, message: $"Left mouse button has been released (position {Position}).", color: Color.Orange);
