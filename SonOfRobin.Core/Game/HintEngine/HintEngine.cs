...
namespace SonOfRobin
{
    public class HintEngine
    {
                ...
                case Type.TooDarkToUseTools:
                    {
                        ...
                        SonOfRobinGame.MessageLog.Add(text: $"Too dark to use {text}.", texture: texture, avoidDuplicates: true);
                        break;
                    }
        ...
        public void RestoreAllHints()
        {
            ...
            SonOfRobinGame.MessageLog.Add(text: "Hints has been restored.");
        }
