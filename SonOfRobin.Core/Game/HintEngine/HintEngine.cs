...
namespace SonOfRobin
{
    public class HintEngine
    {
                ...
                case Type.TooDarkToUseTools:
                    {
                        ...
                        SonOfRobinGame.MessageLog.Add(text: $"Too dark to use {text}.", bgColor: new Color(105, 3, 18), texture: texture, avoidDuplicates: true);
                        break;
                    }
        ...
        public void RestoreAllHints()
        {
            ...
            SonOfRobinGame.MessageLog.Add(debugMessage: true, text: "Hints has been restored.");
        }
