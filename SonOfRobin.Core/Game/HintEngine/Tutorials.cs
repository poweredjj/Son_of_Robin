...
namespace SonOfRobin
{
    public class Tutorials
    {
        ...
        {
            var taskChain = HintMessage.ConvertToTasks(messageList: GetTutorial(type).MessagesToDisplayInMenu, playSounds: false);
        ...
        public static void ShowTutorialOnTheField(Type type, World world, bool ignoreHintsSetting = false, bool ignoreDelay = false, bool ignoreIfShown = true)
        {
            ...
            var messageList = GetTutorial(type).MessagesToDisplay;
        ...
        public static Tutorial[] TutorialsInMenu
        {
            get
            {
                var tutorialsInMenu = new List<Tutorial>();

                foreach (Type type in allTypes)
                {
                    Tutorial tutorial = GetTutorial(type);
                    if (tutorial.isShownInTutorialsMenu) tutorialsInMenu.Add(tutorial);
                }

                return tutorialsInMenu.ToArray();
            }
        }

        public static Tutorial GetTutorial(Type type)
        {
            switch (type)
            {
                case Type.BreakThing:
             ...
             messages: new List<HintMessage>  {
               ...
               messages: new List<HintMessage> {
                ...
                case Type.Craft:
                    return new Tutorial(type: type, name: "crafting", title: "Crafting new items.",
                messages: new List<HintMessage> {
                ...
                case Type.Heat:
                    return new Tutorial(type: type, name: "heat", title: "Heat.",
                messages: new List<HintMessage> {
                ...
                case Type.SwampPoison:
                    return new Tutorial(type: type, name: "poisonous swamp", title: "Poisonous swamp.",
                messages: new List<HintMessage>  {
