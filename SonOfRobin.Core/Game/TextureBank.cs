...
namespace SonOfRobin
{
    public class TextureBank
    {
        public enum TextureName : byte
        {
            ...
            RepeatingGrassGoodBadNormal = 165,
        ...
        private static readonly Dictionary<TextureName, string> filenamesForTextureNames = new()
        {
            ...
            { TextureName.RepeatingMountainLowNormal, "repeating_textures/mountain_low_normal" },
            ...
            { TextureName.RepeatingMountainMediumNormal, "repeating_textures/mountain_medium_normal" },
            ...
            { TextureName.RepeatingMountainHighNormal, "repeating_textures/mountain_high_normal" },
