...
namespace SonOfRobin
{
    public class TextureBank
    {
        public enum TextureName : byte
        {
            ...
            ParticleWeatherFog1 = 105,
            ParticleWeatherFog2 = 106,
            ParticleWeatherFog3 = 107,
            ParticleBubble = 53,
        ...
        private static readonly Dictionary<TextureName, string> filenamesForTextureNames = new Dictionary<TextureName, string>
        {
            ...
            { TextureName.ParticleWeatherFog1, "particles/fog_1" },
            { TextureName.ParticleWeatherFog2, "particles/fog_2" },
            { TextureName.ParticleWeatherFog3, "particles/fog_3" },
