...
namespace SonOfRobin
{
    public class Potion : BoardPiece
    {
        ...
        public Potion(World world, Vector2 position, AnimData.PkgName animPackage, PieceTemplate.Name name, AllowedFields allowedFields, string readableName, string description, Category category, PieceTemplate.Name convertsToWhenUsed,
