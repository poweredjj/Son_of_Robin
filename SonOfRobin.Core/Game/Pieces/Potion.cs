...
namespace SonOfRobin
{
    public class Potion : BoardPiece
    {
        ...
        public Potion(World world, string id, AnimData.PkgName animPackage, PieceTemplate.Name name, AllowedTerrain allowedTerrain, string readableName, string description, Category category, PieceTemplate.Name convertsToWhenUsed, ReadOnlyParams readOnlyParams,
