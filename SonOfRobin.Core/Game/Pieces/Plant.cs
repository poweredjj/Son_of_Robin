...
namespace SonOfRobin
{
    ...
    public class Plant : BoardPiece
    {
        ...
        public bool DropFruit(bool showMessage)
        {
            ...
            {
                if (showMessage) MessageLog.Add(text: $"There is nothing left to shake off from {this.readableName}.", bgColor: new Color(105, 3, 18), texture: this.sprite.AnimFrame.texture, avoidDuplicates: true);
                return false;
            }
