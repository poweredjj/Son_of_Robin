...
namespace SonOfRobin
{
    ...
    public class Plant : BoardPiece
    {
        ...
        public Plant(World world, string id, AnimData.PkgName animPackage, PieceTemplate.Name name, AllowedTerrain allowedTerrain, Dictionary<Terrain.Name, byte> bestEnvironment, string readableName, string description, Category category, ReadOnlyParams readOnlyParams,
