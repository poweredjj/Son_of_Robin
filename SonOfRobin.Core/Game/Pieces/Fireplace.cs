...
namespace SonOfRobin
{
    public class Fireplace : BoardPiece
    {
        ...
        public Fireplace(World world, Vector2 position, AnimPkg animPackage, PieceTemplate.Name name, AllowedFields allowedFields, Dictionary<byte, int> maxMassBySize, byte storageWidth, byte storageHeight, string readableName, string description, Category category, ushort scareRange,
