...
namespace SonOfRobin
{
    public class AlchemyLab : BoardPiece
    {
        ...
        public void TurnOn()
        {
            ...
            ParticleEngine.TurnOn(sprite: this.sprite, preset: ParticleEngine.Preset.HeatSmall);
        ...
        public void TurnOff()
        {
            ...
            ParticleEngine.TurnOff(sprite: this.sprite, preset: ParticleEngine.Preset.HeatSmall);
        ...
        public override void DrawStatBar()
        {
            if (this.world.CurrentUpdate < this.brewingDoneFrame)
            {
                ...
                new StatBar(label: "", value: brewingCurrentFrame, valueMax: brewingDuration, colorMin: new Color(255, 0, 0), colorMax: new Color(255, 128, 0), posX: this.sprite.GfxRect.Center.X, posY: this.sprite.GfxRect.Bottom, ignoreIfAtMax: false, image: AnimData.GetImageObj(AnimData.PkgName.Flame));
            }
        ...
        public void Brew()
        {
            ...
            foreach (Buff buff in buffList)
            {
                ...
                float durationMultiplier = buff.autoRemoveDelay == 0 ? 1f : 1f + (float)(this.world.random.NextSingle() * ((brewLevel - 1) / 2));
            ...
            if (Preferences.debugInstantCookBrewSmelt) brewingTime = 30;
