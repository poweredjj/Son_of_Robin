namespace SonOfRobin
{
    ...
    {
        public Trigger(World world, int id, AnimData.PkgName animPackage, PieceTemplate.Name name, AllowedTerrain allowedTerrain, string readableName, string description, string animName = "default") :
