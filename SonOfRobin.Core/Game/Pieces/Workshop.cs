...
namespace SonOfRobin
{
    public class Workshop : BoardPiece
    {
        ...
        public Workshop(World world, string id, AnimData.PkgName animPackage, PieceTemplate.Name name, AllowedTerrain allowedTerrain, MenuTemplate.Name craftMenuTemplate, string readableName, string description, Category category, bool canBeUsedDuringRain,
