...
namespace SonOfRobin
{
    ...
    {
        public Equipment(World world, Vector2 position, AnimPkg animPackage, PieceTemplate.Name name, AllowedFields allowedFields, List<BuffEngine.Buff> buffList, string readableName, string description,
