...
namespace SonOfRobin
{
    public class Equipment : BoardPiece
    {
        ...
        public Equipment(World world, Vector2 position, AnimPkg animPackage, PieceTemplate.Name name, AllowedFields allowedFields, List<BuffEngine.Buff> buffList,
        ...
        public override Dictionary<string, Object> Serialize()
        {
            ...
            pieceData["equip_buffList"] = this.buffList;
        ...
        public override void Deserialize(Dictionary<string, Object> pieceData)
        {
            ...
            this.buffList = (List<BuffEngine.Buff>)pieceData["equip_buffList"];
        }
