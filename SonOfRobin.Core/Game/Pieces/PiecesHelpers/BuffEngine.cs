                ...
                case BuffType.Sprint:
                    {
                        ...
                        if (add)
                        {
                            ...
                            player.sprite.effectCol.AddEffect(new BorderInstance(outlineColor: Color.Cyan, borderThickness: 1, textureSize: new Vector2(player.sprite.AnimFrame.imageObj.Width, player.sprite.AnimFrame.imageObj.Height), priority: 0, framesLeft: -1));
