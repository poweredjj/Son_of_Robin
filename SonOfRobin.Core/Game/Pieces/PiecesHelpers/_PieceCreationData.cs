    ...
    public struct PieceCreationData
    {
        ...
        public static List<PieceCreationData> CreateDataList(int maxAnimalsPerName)
        {
            var dataList = new List<PieceCreationData>
            {
                ...
                new PieceCreationData(name: PieceTemplate.Name.WaterLily, multiplier: 0.15f, maxAmount: -1),
                ...
                new PieceCreationData(name: PieceTemplate.Name.SwampGas, multiplier: 0.6f, maxAmount: -1, doNotReplenish: true),
                new PieceCreationData(name: PieceTemplate.Name.LavaGas, multiplier: 0.2f, maxAmount: -1, doNotReplenish: true),
