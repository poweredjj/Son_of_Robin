...
namespace SonOfRobin
{
    public readonly struct PieceCreationData
    {
        ...
        public PieceCreationData(PieceTemplate.Name name, float multiplier = 1, int maxAmount = -1, bool temporaryDecoration = false, int tempDecorMultiplier = 1, bool doNotReplenish = false, Level.LevelType levelType = Level.LevelType.Island, int minDepth = 0)
        {
        ...
        public static List<PieceCreationData> CreateDataList(int maxAnimalsPerName, Level level)
        {
            var dataList = new List<PieceCreationData>
            {
                ...
                new PieceCreationData(name: PieceTemplate.Name.GrassGlow, multiplier: 0.1f, maxAmount: 60),
                ...
                new PieceCreationData(name: PieceTemplate.Name.RuinsDigSite, multiplier: 0.12f),

                new PieceCreationData(name: PieceTemplate.Name.Totem, multiplier: 0.1f, maxAmount: 2, doNotReplenish: true),
                new PieceCreationData(name: PieceTemplate.Name.RuinsColumn, multiplier: 0.04f, doNotReplenish: true),
                new PieceCreationData(name: PieceTemplate.Name.RuinsRubble, multiplier: 0.07f, doNotReplenish: true),
                new PieceCreationData(name: PieceTemplate.Name.RuinsWall, multiplier: 0.07f, doNotReplenish: true),
                ...
                new PieceCreationData(name: PieceTemplate.Name.CaveEntranceOutside, multiplier: 0.2f, maxAmount: 4),
