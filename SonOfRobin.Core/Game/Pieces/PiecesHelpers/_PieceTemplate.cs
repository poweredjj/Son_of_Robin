...

{
    public class PieceTemplate
    {
        public enum Name : ushort
        {
            ...
            ChestIron = 60,
            ChestCrystal = 61,
            ChestTreasureNormal = 62,
            ChestTreasureBig = 63,

            CampfireSmall = 64,
            CampfireMedium = 65,

            FertileGroundSmall = 66,
            FertileGroundMedium = 67,
            FertileGroundLarge = 68,

            WorkshopEssential = 69,
            WorkshopBasic = 70,
            WorkshopAdvanced = 71,
            WorkshopMaster = 72,

            WorkshopMeatHarvesting = 73,
            MeatDryingRackRegular = 74,
            MeatDryingRackWide = 75,
            WorkshopLeatherBasic = 76,
            WorkshopLeatherAdvanced = 77,

            AlchemyLabStandard = 78,
            AlchemyLabAdvanced = 79,

            BoatConstructionSite = 80,
            BoatCompleteStanding = 81,
            BoatCompleteCruising = 82,
            ShipRescue = 83,
            ...
            FenceHorizontalShort = 88,
            FenceVerticalShort = 89,
            FenceHorizontalLong = 90,
            FenceVerticalLong = 91,

            FurnaceConstructionSite = 92,
            FurnaceComplete = 93,
            Anvil = 94,
            HotPlate = 95,
            CookingPot = 96,
            ...
            CrystalDepositSmall = 117,
            CrystalDepositBig = 118,
            ...
            BubbleExclamationRed = 137,
            BubbleExclamationBlue = 138,
            BubbleCraftGreen = 139,
            ...
            UpgradeTrigger = 143,
            BrewTrigger = 144,
            MeatHarvestTrigger = 145,
            OfferTrigger = 146,
            ConstructTrigger = 147,
            FireplaceTriggerOn = 148,
            FireplaceTriggerOff = 149,
            ...
            SoundLakeWaves = 221,
            SoundSeaWind = 222,
            SoundNightCrickets = 223,
            SoundNoonCicadas = 224,
            SoundLava = 225,
            SoundCaveWaterDrip = 226,

            SeaWave = 227,
            PredatorRepellant = 228,
            WeatherFog = 229,
            WaterEdgeDistort = 230,

            ParticleEmitterEnding = 231,
            ParticleEmitterWeather = 232,
            EmptyVisualEffect = 233,
            HastePlayerClone = 234,

            CaveEntranceOutside = 235,
            CaveEntranceInside = 236,
            CaveExit = 237,
            CaveExitEmergency = 238,
        ...
        public static BoardPiece CreatePiece(Name templateName, World world, int id = -1, bool createdByPlayer = false)
        {
            ...
            switch (templateName)
            {
                ...
                case Name.LanternFull:
                    {
                        LightEngine storedLightEngine = new LightEngine(size: 800, opacity: 0.9f, colorActive: true, color: new Color(247, 244, 47) * 0.2f, isActive: false, castShadows: true);
        ...
        private static AllowedTerrain CreatePlayerAllowedTerrain()
        {
            return new AllowedTerrain(
                rangeNameList: new List<AllowedTerrain.RangeName> { AllowedTerrain.RangeName.WaterShallow, AllowedTerrain.RangeName.WaterMedium, AllowedTerrain.RangeName.GroundAll, AllowedTerrain.RangeName.Volcano, AllowedTerrain.RangeName.NoBiome, AllowedTerrain.RangeName.VeryHumid },
                extPropertiesDict: new Dictionary<ExtBoardProps.Name, bool> { { ExtBoardProps.Name.OuterBeach, true } });
        }
    }
}