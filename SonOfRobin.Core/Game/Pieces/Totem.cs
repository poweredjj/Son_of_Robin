...
namespace SonOfRobin
{
    public class Totem : BoardPiece
    {
        ...
        public Totem(World world, int id, AnimDataNew.PkgName animPackage, PieceTemplate.Name name, AllowedTerrain allowedTerrain, string readableName, string description,
             int maxHitPoints = 1) :
        ...
        public void Offer()
        {
            ...
            MessageLog.Add(debugMessage: true, text: $"goodOfferingMass {goodOfferingMass} delay {weatherChangeDelay} timespan {weatherChangeDuration}");
