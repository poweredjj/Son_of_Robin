...
namespace SonOfRobin
{
    public class Fruit : BoardPiece
    {
        ...
        public Fruit(World world, int id, AnimDataNew.PkgName animPackage, PieceTemplate.Name name, AllowedTerrain allowedTerrain, string readableName, string description, bool mightContainSeeds,
