...
namespace SonOfRobin
{
    public abstract class BoardPiece
    {
            ...
            byte animSize = 0, string animName = "default", float speed = 1, bool visible = true, bool ignoresCollisions = false, int maxAge = 0, bool floatsOnWater = false, int generation = 0, int staysAfterDeath = 800, float maxHitPoints = 1, Yield yield = null, Yield appearDebris = null, bool rotatesWhenDropped = false, List<Buff> buffList = null, AllowedDensity allowedDensity = null, int strength = 0, LightEngine lightEngine = null, PieceSoundPack soundPack = null, bool isAffectedByWind = true)
        {
            ...
            this.sprite = new Sprite(boardPiece: this, id: this.id, world: this.world, animPackage: animPackage, animSize: animSize, animName: animName, visible: visible, ignoresCollisions: ignoresCollisions, allowedTerrain: allowedTerrain, floatsOnWater: floatsOnWater, allowedDensity: allowedDensity, lightEngine: lightEngine, isAffectedByWind: isAffectedByWind);
