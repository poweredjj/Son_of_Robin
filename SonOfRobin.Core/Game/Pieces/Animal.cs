...
namespace SonOfRobin
{
    public class Animal : BoardPiece
    {
        ...
        public override void DrawStatBar()
        {
            ...
            new StatBar(label: "hp", value: (int)this.HitPoints, valueMax: (int)this.maxHitPoints, colorMin: new Color(255, 0, 0), colorMax: new Color(0, 255, 0), posX: posX, posY: posY, image: AnimData.GetImageObj(AnimData.PkgName.Heart));
            ...
            if (Preferences.debugShowStatBars)
            {
                ...
                new StatBar(label: "food", value: (int)this.fedLevel, valueMax: (int)maxFedLevel, colorMin: new Color(0, 128, 255), colorMax: new Color(0, 255, 255), posX: posX, posY: posY, image: AnimData.GetImageObj(AnimData.PkgName.Burger));
