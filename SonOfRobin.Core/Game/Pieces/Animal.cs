...
namespace SonOfRobin
{
    public class Animal : BoardPiece
    {
        ...
        public override void DrawStatBar()
        {
            ...
            new StatBar(label: "hp", value: (int)this.HitPoints, valueMax: (int)this.maxHitPoints, colorMin: new Color(255, 0, 0), colorMax: new Color(0, 255, 0), posX: posX, posY: posY, texture: AnimData.croppedFramesForPkgs[AnimData.PkgName.Heart].texture);
            ...
            if (Preferences.debugShowStatBars)
            {
                ...
                new StatBar(label: "food", value: (int)this.fedLevel, valueMax: (int)maxFedLevel, colorMin: new Color(0, 128, 255), colorMax: new Color(0, 255, 255), posX: posX, posY: posY, texture: AnimData.croppedFramesForPkgs[AnimData.PkgName.Burger].texture);
        ...
        {
            energyAmount *= this.pieceInfo.animalMassBurnedMultiplier;
        ...
        public override void SM_AnimalGiveBirth()
        {
            ...
            for (int i = 0; i < noOfChildren; i++)
            {
                ...
                BoardPiece child = PieceTemplate.CreatePiece(world: this.world, templateName: this.name);
        ...
        public override void SM_AnimalCallForHelp()
        {
            ...
            if (willFollowPlayerAnywhere) this.sprite.allowedTerrain.CopyTerrainFromTemplate(this.world.Player.sprite.allowedTerrain);
