...
namespace SonOfRobin
{
    public class Shelter : BoardPiece
    {
        ...
        public Shelter(World world, string id, AnimData.PkgName animPackage, PieceTemplate.Name name, AllowedTerrain allowedTerrain, Dictionary<byte, int> maxMassBySize, SleepEngine sleepEngine, string readableName, string description, Category category,
            ...
            base(world: world, id: id, animPackage: animPackage, animSize: animSize, animName: animName, blocksMovement: blocksMovement, minDistance: minDistance, maxDistance: maxDistance, name: name, destructionDelay: destructionDelay, allowedTerrain: allowedTerrain, floatsOnWater: floatsOnWater, maxMassBySize: maxMassBySize, generation: generation, stackSize: stackSize, canBePickedUp: canBePickedUp, yield: yield, maxHitPoints: maxHitPoints, rotatesWhenDropped: false, readableName: readableName, description: description, buffList: buffList, category: category, lightEngine: lightEngine, activeState: State.Empty)
        {
