...
namespace SonOfRobin
{
    public class Shelter : BoardPiece
    {
        ...
        public Shelter(World world, int id, AnimDataNew.PkgName animPackage, PieceTemplate.Name name, AllowedTerrain allowedTerrain, SleepEngine sleepEngine, string readableName, string description,
