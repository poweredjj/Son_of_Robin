...
namespace SonOfRobin
{
    public class Sound
    {
        ...
        public Sound(SoundData.Name name = SoundData.Name.Empty, List<SoundData.Name> nameList = null, BoardPiece boardPiece = null, float volume = 1f, bool isLooped = false, int cooldown = 0, bool ignore3DAlways = false, float maxPitchVariation = 0f, float pitchChange = 0f)
        {
        ...
        public void Play(bool ignore3DThisPlay = false, bool ignoreCooldown = false)
        {
            ...
            {
                if (this.boardPiece.world.currentUpdate < this.lastFramePlayed + cooldown) return;
                this.lastFramePlayed = this.boardPiece.world.currentUpdate;
            }
            ...
            instance.Volume = this.volume * globalVolume;
