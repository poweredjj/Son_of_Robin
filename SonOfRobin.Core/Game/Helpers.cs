...
namespace SonOfRobin
{
    public class Helpers
    {
        ...
        public static List<TextWithImages> MakeCreditsTextList()
        {
            ...
            textList.Add(new TextWithImages(font: fontText, text: "Materials: https://3dtextures.me, https://free-3dtextureshd.com/, https://freepbr.com/", imageList: new List<ImageObj>()));
            ...
            textList.Add(new TextWithImages(font: fontText, text: "Night Of Mystery by Alexander Nakarada (CreatorChords) https://creatorchords.com", imageList: new List<ImageObj>()));
