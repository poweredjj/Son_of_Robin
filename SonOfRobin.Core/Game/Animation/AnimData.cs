...
namespace SonOfRobin
{
    public class AnimData
    {
        ...
        public enum PkgName : ushort
        {
            ...
            PotionGreen = 245,
            PotionBlack = 246,
            PotionDarkViolet = 247,
            PotionDarkYellow = 248,
            PotionDarkGreen = 249,
            PotionLightYellow = 250,
            PotionTransparent = 251,
            PotionBrown = 252,
            ...
            BubbleExclamationRed = 278,
            BubbleExclamationBlue = 279,
            BubbleCraftGreen = 280,
            ...
            FertileGroundSmall = 291,
            FertileGroundMedium = 292,
            FertileGroundLarge = 293,
            FenceHorizontalShort = 294,
            FenceVerticalShort = 295,
            FenceHorizontalLong = 296,
            FenceVerticalLong = 297,
