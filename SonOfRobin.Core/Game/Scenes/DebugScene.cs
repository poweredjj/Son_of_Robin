...
namespace SonOfRobin
{
    public class DebugScene : Scene
    {
        ...
        public void ProcessDebugInput()
        {
            ...
            if (Keyboard.HasBeenPressed(Keys.F1))
            {
                world.weather.AddEvent(new WeatherEvent(type: Weather.WeatherType.Rain, intensity: 1f, startTime: world.islandClock.IslandDateTime, duration: TimeSpan.FromMinutes(20), transitionLength: TimeSpan.FromMinutes(3)));
            }
