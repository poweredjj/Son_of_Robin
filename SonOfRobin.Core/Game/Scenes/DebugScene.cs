...
namespace SonOfRobin
{
    public class DebugScene : Scene
    {
        ...
        public override void Update()
        {
            ...
            debugLines.Add($"loaded snd: {SoundData.LoadedSoundsCount}/{SoundData.AllSoundsCount} tx pers: {TextureBank.LoadedTexturesCountPersistent} tmp: {TextureBank.LoadedTexturesCountTemporary} animPkg {AnimData.LoadedPkgsCount}/{AnimData.allPkgNames.Length}");
