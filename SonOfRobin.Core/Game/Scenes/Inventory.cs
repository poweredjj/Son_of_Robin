    ...
    public class Inventory : Scene
    {
        ...
        private bool IgnoreUpdateAndDraw
        {
            get
            {
                ...
                var ignoredTypes = new List<System.Type> { typeof(TextWindow), typeof(ControlTips), typeof(StackView), typeof(DebugScene), typeof(MessageLog), typeof(InfoWindow), typeof(FullScreenProgressBar), typeof(TouchOverlay), typeof(FpsCounter), typeof(BlendStateEditor) };
        ...
        public void ReleaseHeldPieces(StorageSlot slot, bool forceReleaseAll = false)
        {
            ...
            {
                firstPieceSoundPack.Play(action: PieceSoundPackTemplate.Action.IsDropped, ignore3D: true, ignoreCooldown: true);
        ...
        private void SwapDraggedAndSlotPieces(StorageSlot slot)
        {
            ...
            this.draggedPieces[0].activeSoundPack.Play(action: PieceSoundPackTemplate.Action.IsDropped, ignore3D: true, ignoreCooldown: true);
        ...
        public void DrawCursor()
        {
            ...
            Helpers.DrawTextureInsideRect(texture: cursorTexture, rectangle: cursorRect, color: Color.White, alignX: Helpers.AlignX.Left, alignY: Helpers.AlignY.Top, drawTestRect: false);
        }
    }
}