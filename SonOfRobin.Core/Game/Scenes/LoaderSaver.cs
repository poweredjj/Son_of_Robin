...
namespace SonOfRobin
{
    public class LoaderSaver : Scene
    {
        ...
        {
            GfxConverter.SaveTextureAsPNGResized(pngPath: Path.Combine(this.savePath, screenshotName), texture: this.world.FinalRenderTarget, maxWidth: 640, maxHeight: 480); // screenshot should not be too large (because many might be loaded at once)
