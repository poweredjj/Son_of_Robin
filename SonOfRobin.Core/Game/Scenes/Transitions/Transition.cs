...
namespace SonOfRobin
{
    public class Transition
    {
...

        {
            ...
            //  SonOfRobinGame.messageLog.AddMessage(text: $"New trans: {this.scene.GetType()} {this.baseParamName} {this.sourceVal} -> {this.targetVal}", color: Color.LightCyan); // for testing
