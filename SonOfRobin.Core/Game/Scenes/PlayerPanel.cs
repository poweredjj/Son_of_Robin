...
namespace SonOfRobin
{
    public class PlayerPanel : Scene
    {
        ...
        public override void Draw()
        {
            ...
            new StatBar(width: width, height: height, label: $"health {player.hitPoints}/{player.maxHitPoints}", value: (int)player.hitPoints, valueMax: (int)player.maxHitPoints, colorMin: new Color(255, 0, 0), colorMax: new Color(0, 255, 0), posX: posX, posY: posY, ignoreIfAtMax: true, centerX: false, drawFromTop: true, labelAtLeft: true, vOffsetCorrection: vOffsetCorrection);
