    ...
    public class CraftData
    {
        ...
        public static List<Craft.Recipe> GetFieldRecipes()
        {
            return new List<Craft.Recipe> {
                ...
                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.AlchemyLabStandard, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.Stone, 4 }, { PieceTemplate.Name.Granite, 2 }, { PieceTemplate.Name.WoodPlank, 4 }, { PieceTemplate.Name.Clay, 1 }, { PieceTemplate.Name.IronPlate, 3 }, { PieceTemplate.Name.EmptyBottle, 2 } }, fatigue: fatigueStructureSmall, isReversible: true, isHidden: true),
                ...
                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.ChestIron, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.IronPlate, 2 },{ PieceTemplate.Name.WoodPlank, 4 }, { PieceTemplate.Name.Nail, 10 } }, fatigue: fatigueStructureMedium, isReversible: true, isHidden: true, unlocksWhenCrafted: new List<PieceTemplate.Name> {PieceTemplate.Name.ChestCrystal }, craftCountToUnlock: 3),

                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.ChestCrystal, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.Crystal, 3 },{ PieceTemplate.Name.IronPlate, 3 }, { PieceTemplate.Name.WoodLogHard, 6 }, { PieceTemplate.Name.Nail, 20 } }, fatigue: fatigueStructureMedium, isReversible: true, isHidden: true),
        ...
        public static List<Craft.Recipe> GetAdvancedWorkshopRecipes()
        {
            return new List<Craft.Recipe> {
                    ...
                    new Craft.Recipe(pieceToCreate: PieceTemplate.Name.LanternEmpty, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.IronPlate, 2 }, { PieceTemplate.Name.Nail, 25 }, { PieceTemplate.Name.EmptyBottle, 1 } }, fatigue: fatigueItemMedium, isReversible: false),
        ...
        public static List<Craft.Recipe> GetAdvancedLeatherRecipes()
        {
            return new List<Craft.Recipe>
            {
                ...
                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.Dungarees, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.Leather, 3 }, { PieceTemplate.Name.Rope, 1 }, { PieceTemplate.Name.Nail, 15 }}, fatigue: fatigueItemMedium, isReversible: false),
