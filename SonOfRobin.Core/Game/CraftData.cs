    ...
    public class CraftData
    {
        public static List<Craft.Recipe> GetFieldRecipes()
        {
            return new List<Craft.Recipe> {
                ...
                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.WorkshopBasic, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.WoodPlank, 20 }, { PieceTemplate.Name.WoodLogHard, 4 }, { PieceTemplate.Name.Stone, 5 }, { PieceTemplate.Name.Granite, 2 } }, isReversible: true, isHidden: true, unlocksWhenCrafted: new List<PieceTemplate.Name> { PieceTemplate.Name.WorkshopAdvanced, PieceTemplate.Name.CombineWorkshop, PieceTemplate.Name.Furnace, PieceTemplate.Name.HotPlate }),

                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.CombineWorkshop, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.WoodPlank, 12 },  { PieceTemplate.Name.Nail, 10 },  { PieceTemplate.Name.IronPlate, 1 } }, isReversible: true, isHidden: true ),
        ...
        public static List<Craft.Recipe> GetAdvancedWorkshopRecipes()
        {
            return new List<Craft.Recipe> {
                    ...
                    new Craft.Recipe(pieceToCreate: PieceTemplate.Name.SpearPoisoned, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.SpearStone, 1 }, { PieceTemplate.Name.BottleOfPoison, 3 }}, isReversible: false, isHidden: true),
                    ...
                    new Craft.Recipe(pieceToCreate: PieceTemplate.Name.ArrowPoisoned, amountToCreate: 3, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.ArrowStone, 3 }, { PieceTemplate.Name.BottleOfPoison, 1 }}, isReversible: false, isHidden: true),
        ...
        public static List<Craft.Recipe> GetAlchemyRecipes()
        {
            return new List<Craft.Recipe> {
                ...
                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.PotionMaxHP, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.EmptyBottle, 1 }, { PieceTemplate.Name.Apple, 2 }, { PieceTemplate.Name.HerbsGreen, 3 }}, isReversible: false),
