...
namespace SonOfRobin
{
    ...
    public class LevelEvent
    {
        public enum EventName : byte
        {
            ...
            FinishSmelting = 5,
            FinishBrewing = 6,
            RestorePieceCreation = 7,
            FadeOutSprite = 8,
            RestoreHint = 9,
            RemoveBuff = 10,
            BurnOutLightSource = 11,
            RegenPoison = 12,
            ChangeActiveState = 13,
            FinishBuilding = 14,
            PlaySoundByName = 15,
            YieldDropDebris = 16,
            AnimalCallForHelp = 17,
            StopBurning = 18,
            TurnOffHarvestingWorkshop = 19,
            DropDebris = 20,
            SwitchLightEngine = 21,
            TotemAffectWeather = 22,
            CheckForPieceHints = 23,
        }
                ...
                case EventName.BurnOutLightSource:
                    {
                        ...
                        {
                            world.HintEngine.ShowGeneralHint(type: HintEngine.Type.BurntOutTorch, ignoreDelay: true, text: portableLight.readableName, imageObj: portableLight.sprite.AnimFrame.imageObj);
                            MessageLog.Add(text: $"{Helpers.FirstCharToUpperCase(this.boardPiece.readableName)} has burnt out.", imageObj: this.boardPiece.sprite.AnimFrame.imageObj, bgColor: new Color(105, 3, 18), textColor: Color.White);
