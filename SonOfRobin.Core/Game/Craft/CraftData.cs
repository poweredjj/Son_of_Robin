    ...
    public class CraftData
    {
        ...
        public static List<Craft.Recipe> GetFieldRecipes()
        {
            return new List<Craft.Recipe> {
                ...
                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.FertileGroundMedium, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.Clay, 4 }, { PieceTemplate.Name.ShovelStone, 1 }}, fatigue: fatigueStructureMedium, isReversible: false, isHidden: true, unlocksWhenCrafted: new List<PieceTemplate.Name> {PieceTemplate.Name.FertileGroundBig }, craftCountToUnlock: 2, craftCountToLevelUp: 2, maxLevel: 5),

                new Craft.Recipe(pieceToCreate: PieceTemplate.Name.FertileGroundBig, ingredients: new Dictionary<PieceTemplate.Name, byte> { { PieceTemplate.Name.Clay, 6 }, { PieceTemplate.Name.ShovelIron, 1 }}, fatigue: fatigueStructureBig, isReversible: false, isHidden: true, craftCountToLevelUp: 3, maxLevel: 3),
